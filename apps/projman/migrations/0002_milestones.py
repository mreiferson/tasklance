...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Project.milestone'
        db.delete_column('projman_project', 'milestone_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Project.milestone'
        db.add_column('projman_project', 'milestone', orm['projman.project:milestone'])
    ...
    models = {
        ...
        'projman.project': {
            ...
            'description': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'milestones': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['projman.Milestone']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'priority': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'})
        },
        'projman.task': {
