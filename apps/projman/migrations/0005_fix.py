...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.add_column('projman_project', 'category', orm['projman.project:category'])
        
        # Deleting field 'Project.account'
        db.delete_column('projman_project', 'account_id')
    ...
    def backwards(self, orm):
        ...
        db.delete_column('projman_project', 'category_id')
        
        # Adding field 'Project.account'
        db.add_column('projman_project', 'account', orm['projman.project:account'])
