...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StatusChange.reason'
        db.add_column('projman_statuschange', 'reason', orm['projman.statuschange:reason'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'StatusChange.reason'
        db.delete_column('projman_statuschange', 'reason')
