...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Thread.created'
        db.add_column('projman_thread', 'created', orm['projman.thread:created'])
        
        # Adding field 'Message.creator'
        db.add_column('projman_message', 'creator', orm['projman.message:creator'])
        
        # Adding field 'Message.created'
        db.add_column('projman_message', 'created', orm['projman.message:created'])
        
        # Adding field 'Thread.creator'
        db.add_column('projman_thread', 'creator', orm['projman.thread:creator'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Thread.created'
        db.delete_column('projman_thread', 'created')
        
        # Deleting field 'Message.creator'
        db.delete_column('projman_message', 'creator_id')
        
        # Deleting field 'Message.created'
        db.delete_column('projman_message', 'created')
        
        # Deleting field 'Thread.creator'
        db.delete_column('projman_thread', 'creator_id')
