...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Thread.content_type'
        db.add_column('projman_thread', 'content_type', orm['projman.thread:content_type'])
        
        # Deleting field 'Thread.relation_model'
        db.delete_column('projman_thread', 'relation_model')
        
        # Deleting field 'Thread.relation_id'
        db.delete_column('projman_thread', 'relation_id')
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Thread.content_type'
        db.delete_column('projman_thread', 'content_type_id')
        
        # Adding field 'Thread.relation_model'
        db.add_column('projman_thread', 'relation_model', orm['projman.thread:relation_model'])
        
        # Adding field 'Thread.relation_id'
        db.add_column('projman_thread', 'relation_id', orm['projman.thread:relation_id'])
